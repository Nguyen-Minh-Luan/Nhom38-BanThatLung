...
<html lang="en">
  <head>
    ...
    <link rel="stylesheet" href="${pageContext.request.contextPath}/css/hotProductPage.css" />
      ...
      <div class="col-11 bg-light">
        <div class="d-flex flex-column mt-5">
          ...
          <div class="d-flex flex-column justify-content-left align-items-left">
            <div class="d-flex align-items-center mt-4 mb-4 ms-5">
                ...
                <table class="table text-center">
                  <thead>
                    <tr>
                      ...
                      <th scope="col">Số lượng review</th>
