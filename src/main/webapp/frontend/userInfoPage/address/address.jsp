...
<div class="container-lg">
    <div class="d-flex flex-column">
                        ...
                        <div class="modal-body">
                            <form>
                                ...
                                <div class="d-flex flex-column">
                                    ...
                                    <select id="province" class="form-select custom_design">
                                ...
                                <div class="d-flex flex-column">
                                    <p class="mt-3 mb-1">Số điện thoại</p>
                                    <input
                                            type="tel"
                                            class="form-control custom_design phoneNumber"
                                    />
                                </div>
                                <div class="d-flex flex-column">
        ...
        <div class="d-flex mb-5">
            <div
                    class="address__info d-flex flex-column me-5 custom_hover py-5 ps-2 pe-3"
            >
            <span
                    class="d-flex justify-content-center btn border-3 border-dark rounded-pill text-dark px-0 mb-4 w-50 custom_default"
            >Mặc định</span
            >
                <p class="custom_name_display">huynh minh thang</p>
                <p class="custom_address_detail_display">ktx khu b</p>
                <p class="custom_address">THÀNH PHỐ HỒ CHÍ MINH</p>
                <p class="custom_phoneNumber_display">+84356176054</p>
                <div class="address__info__action mt-4">
                    ...
                    <button
                            type="button"
                            class="btn btn-light text-dark rounded-pill fw-bold"
                            data-bs-toggle="modal"
                            data-bs-target="#deleteModal"
                    >
                        <img src="../../assets/icons/delete.svg"/>Xóa
                    </button>
                    <div
                            class="modal fade"
                            id="deleteModal"
                        ...
                        <div class="modal-dialog">
                            <div class="modal-content">
                                ...
                                <div class="modal-footer">
                                    ...
                                    <button
                                            type="button"
                                            class="btn btn-dark custom_delete_address"
                                            data-bs-dismiss="modal"
                                    >
                                        Xóa
                                    </button>
